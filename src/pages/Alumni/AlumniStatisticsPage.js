...
const AlumniStatisticsPage = () => {
    ...
    useEffect(() => {
        setDoughnut({
            labels: expenseAmountPerCategory.map(item => item.key),
            data: expenseAmountPerCategory.map(item => item.value),
        });
...
export default AlumniStatisticsPage;
